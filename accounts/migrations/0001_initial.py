    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('CSE', 'Computer Science'), ('ECE', 'Electronics'), ('MECH', 'Mechanical'), ('CIVIL', 'Civil'), ('EEE', 'Electrical'), ('IT', 'Information Technology'), ('MBA', 'Business Administration'), ('MCA', 'Computer Applications')], max_length=10)),
                ('year', models.IntegerField(choices=[(1, '1 Year'), (2, '2 Year'), (3, '3 Year'), (4, '4 Year'), (5, '5 Year')], default=1)),
